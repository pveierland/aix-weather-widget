		...
		case DEVICE_PROFILES:
		{
			if (resultCode == EXIT_CONFIGURATION)
			{
				...
				if (editMode)
				{
					...
					{
						startService(new Intent(isProviderModified ? AixService.ACTION_UPDATE_ALL_PROVIDER_CHANGE : AixService.ACTION_UPDATE_ALL, widgetUri, this, AixService.class));
					}
					else
					{
						startService(new Intent(AixService.ACTION_UPDATE_WIDGET, widgetUri, this, AixService.class));
					}
