...
public class AixUpdate {
	...
	private void scheduleUpdate(long updateTime) {
		...
		Intent updateIntent = new Intent(AixService.ACTION_UPDATE_WIDGET, mWidgetUri, mContext, AixService.class);
		PendingIntent pendingUpdateIntent = PendingIntent.getService(mContext, 0, updateIntent, 0);
