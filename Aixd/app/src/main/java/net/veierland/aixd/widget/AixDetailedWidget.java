...
import static net.veierland.aixd.AixUtils.WEATHER_ICONS_DAY;
import static net.veierland.aixd.AixUtils.WEATHER_ICONS_NIGHT;
import static net.veierland.aixd.AixUtils.WEATHER_ICONS_POLAR;
import static net.veierland.aixd.AixUtils.hcap;
import static net.veierland.aixd.AixUtils.isPrime;
import static net.veierland.aixd.AixUtils.lcap;
import static net.veierland.aixd.AixUtils.truncateDay;
import static net.veierland.aixd.AixUtils.truncateHour;
...
import net.veierland.aixd.SunMoonData;
import net.veierland.aixd.util.AixLocationInfo;
import net.veierland.aixd.util.AixWidgetInfo;
import net.veierland.aixd.util.AixWidgetSettings;
import net.veierland.aixd.util.CatmullRomSpline;
import net.veierland.aixd.util.Cubic;
import net.veierland.aixd.util.Cubic.CubicResult;
import net.veierland.aixd.util.DayState;
import net.veierland.aixd.util.Pair;
