...
import static net.veierland.aixd.AixSettings.CALIBRATION_STATE_FINISHED;
import static net.veierland.aixd.AixSettings.CALIBRATION_STATE_VERTICAL;
import static net.veierland.aixd.AixSettings.LANDSCAPE_HEIGHT;
import static net.veierland.aixd.AixSettings.LANDSCAPE_WIDTH;
import static net.veierland.aixd.AixSettings.PORTRAIT_HEIGHT;
import static net.veierland.aixd.AixSettings.PORTRAIT_WIDTH;

import java.io.IOException;
import java.util.HashMap;
import java.util.Map;

import net.veierland.aix.AixWidget;
...
public class AixService extends IntentService {
	...
	public AixService() {
		super("net.veierland.aixd.AixService");
	}
